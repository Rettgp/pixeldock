...
import {
  parseManifest,
} from '../../src/main/library-parser/SteamManifestParser';

let parsedGame: any;
let thrownError: Error | null = null;

Given('a manifest file {string} with valid content', function (filename: string) {
  mockFs({
    [filename]: `
      "AppState"
      {
...
Given('a manifest file {string} missing the {word}', function (filename: string, missingField: string) {
